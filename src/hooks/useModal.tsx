import {useState, useCallback, useRef, useEffect, ReactNode, HTMLAttributes} from "react";
...
export default function useModal() {
  ...
  const Modal = ({ children, className }: { children: ReactNode, className?: HTMLAttributes<string | undefined> }) => (
    <AnimatePresence>
      {isOpen && (
        <motion.div
