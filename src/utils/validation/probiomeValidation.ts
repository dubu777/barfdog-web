...
export const probiomeStepSchema = yup.object({
  step1: yup.object({
...
export type ProbiomeStepValues = yup.InferType<typeof probiomeStepSchema>;
export type ProbiomeStepKeys = keyof ProbiomeStepValues;

export const defaultProbiomeStepValues: ProbiomeStepValues = {
  step1: { bodyFit: "" },
  step2: {
    probioticsStatus: "",
    probioticsProduct: "",
