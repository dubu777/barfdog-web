...
const reasonBarfdogList = [
  {
    key: "item1",
    title: "수의 영양사가 설계한 레시피",
    description:
      "육고기, 뼈, 내장, 채소, 영양제의 완벽한 포뮬러로\n우리 아이에게 맞춤 식단을 제공합니다",
    descriptionMobile:
      "육고기, 뼈, 내장, 채소, 영양제의\n완벽한 포뮬러로우리 아이에게\n맞춤 식단을 제공합니다",
  ...
  },
  {
    ...
    title: "한 끼 한 팩\n편리하게 소분된 맞춤 식단",
    description:
      "위생적인 저온 생산 공정 후 멸균 처리된 한 끼 한 팩 식사를\n간편하게 급여할 수 있습니다",
    descriptionMobile:
      "위생적인 저온 생산 공정 후\n멸균 처리된 한 끼 한 팩 식사를\n간편하게 급여할 수 있습니다",
...
const servicesByBarfdogList = [
  {
    key: "item1",
    title: "75만 건 이상의 빅데이터 기반\nAI 추천 알고리즘",
    description:
      "국내외 논문과 75만건 이상의 빅데이터로\nAI 맞춤 서비스를 제공합니다",
