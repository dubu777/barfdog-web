export const MAIN_DATA = {
	REVIEW: {
		...
		description: '생식이 처음이라 걱정했지만, 바프독과 함께한 이후 피부, 장건강, 입맛까지 달라졌어요. 우리 아이의 행복한 변화를 느껴보세요.',
		action: {
			label: '이용 후기 더 보러가기',
			variant: 'outline',
			url: '/review',
	...
	STORE: {
		title: '시작이 망설여지시나요?',
		subTitle: '정기 구독 전 자연식 샘플 구매를 통해\n바프독 레시피 기호도를 테스트 해보세요!',
		action: {
			label: '단품 구매 하러가기',
			variant: 'outline',
			url: '/store',
	...
	CHAPTER: [
		{
			id: 'survey',
			title: '간단하게 입력하는\n우리아이 건강 정보',
			subTitle: '복잡한 절차 없이, 우리 아이 건강 상태만\n입력하면 누구나 쉽게 시작할 수 있어요',
			action: {
	...
	DELIVERY: {
		...
		description: '바쁜 일상 속, 우리 아이 밥 걱정은 없도록\n바프독이 도와드려요',
