...
const DISEASE_INFO = {
  ...
  OSTEOCHONDRITIS_DISSECANS: {
    ...
    causes:
      "연골 발달 이상, 성장기 과도한 운동, 영양 불균형, 유전적 요인, 외상, 빠른 성장",
    symptoms: "다리 절뚝거림, 운동 기피, 관절 부위 통증, 부종, 움직임 감소",
    management:
      "성장기에는 과격한 운동을 피하고, 균형 잡힌 식단을 제공해요. 증상이 나타나면 조기 치료로 관절 손상을 예방하는 것이 중요합니다.",
    value: 1,
  },
  PATELLAR_LUXATION_GRADE_1: {
    ...
    management:
      "초기 단계에서는 체중을 적정하게 유지하고, 무리한 점프나 미끄러짐을 예방해 무릎 부담을 줄여야 해요.",
    value: 6,
  },
  PATELLAR_LUXATION_GRADE_2: {
    ...
    management:
      "점프나 미끄러운 바닥을 피하고, 무릎 근육 강화를 위한 가벼운 운동을 병행하는 것이 좋아요.",
    value: 4,
  },
  PATELLAR_LUXATION_GRADE_3: {
    ...
    causes:
      "무릎 관절 변형, 유전적 요인, 골격 비대칭, 근육 불균형, 반복된 충격",
    symptoms: "자주 무릎이 빠짐, 보행 불안정, 절뚝거림, 통증, 운동 거부",
    management:
      "관절 건강을 위해 과격한 운동은 피하고, 통증이 지속되면 정형외과 전문의의 진료를 받는 것이 좋아요.",
    value: 2,
  },
  PATELLAR_LUXATION_GRADE_4: {
    ...
    symptoms:
      "지속적인 다리 들기, 절뚝거림, 무릎 고정 상태, 극심한 통증, 보행 불가",
    management:
      "4기는 수술이 필요한 경우가 많기 때문에 조기에 진단하고 치료를 받는 것이 중요해요. ",
    value: 1,
  },
  ARRHYTHMIA: {
    category: "심혈관계",
...
const getOptionByLabel = (label: string) => {
  return [
    ...
    ...DISEASE_INFO_LIST.filter((disease) => disease.category === label).map(
      (disease) => ({
        key: disease.en,
        label: disease.ko,
        value: disease.value,
