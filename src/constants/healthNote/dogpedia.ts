...
const BREED_CHARACTERISTICS_CATEGORY = {
	FAMILY_LIFE: '가족',
	PHYSICAL: '신체',
	SOCIAL: '사회성',
	PERSONALITY: '성격',
...
const BREED_CHARACTERISTICS_CATEGORY_LIST = toLabelValueList(BREED_CHARACTERISTICS_CATEGORY);

const BREED_CHARACTERISTICS_QUESTION = {
	FAMILY_LIFE: {
		affectionLevel: {
			label: '가족을 얼마나 좋아할까요?',
			minLevel: '혼자 있는게 좋아요',
