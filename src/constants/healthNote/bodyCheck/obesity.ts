...
export const OBESITY_SURVEY_ITEMS = [
  {
    ...
    options: [
      { key: "ribs-1", label: "매우 쉽게 만져져요", value: 5 },
      { key: "ribs-2", label: "약간의 지방층과 함께 쉽게 만져져요", value: 4 },
      { key: "ribs-3", label: "적당하게 만져져요", value: 3 },
      { key: "ribs-4", label: "지방이 있어 잘 만져지지 않아요", value: 2 },
      { key: "ribs-5", label: "아예 만져지지 않아요", value: 1 },
    ],
  },
  {
    key: "waistLine",
    ...
    options: [
      ...
      { key: "waistLine-3", label: "허리선이 잘 구별돼요", value: 3 },
      { key: "waistLine-4", label: "허리선이 거의 보이지 않아요", value: 2 },
      {
        key: "waistLine-5",
  ...
  },
  {
    ...
    options: [
      ...
      { key: "abdominalLine-4", label: "복부가 평평해요", value: 2 },
      { key: "abdominalLine-5", label: "복부가 심하게 처져 있어요", value: 1 },
    ],
  },
  {
    key: "weightGain",
    ...
    options: [
      { key: "weightGain-1", label: "일정하게 유지되고 있어요", value: 8 },
      {
        key: "weightGain-2",
  ...
  },
  {
    ...
    options: [
      { key: "easyFatigue-1", label: "아니요", value: 8 },
      { key: "easyFatigue-2", label: "가끔 지칠 때가 있어요", value: 6 },
  ...
  },
  {
    ...
    options: [
      { key: "climbJump-1", label: "아니요", value: 8 },
      { key: "climbJump-2", label: "가끔 머뭇거려요", value: 6 },
  ...
  // 7. 무기력
  {
    ...
    options: [
      { key: "lethargy-1", label: "아니요", value: 8 },
      { key: "lethargy-2", label: "가끔 늘어져 있어요", value: 6 },
  ...
  // 8. 허기짐
  {
    ...
    options: [
      { key: "hunger-1", label: "아니요", value: 8 },
      { key: "hunger-2", label: "가끔 더 먹으려는 행동을 보여요", value: 6 },
  ...
  // 9. 간식량
  {
    ...
    options: [
      { key: "snackFrequency-1", label: "거의 먹지 않아요", value: 8 },
      { key: "snackFrequency-2", label: "하루 1회", value: 6 },
  ...
  // 10. 식사량
  {
    ...
    options: [
      { key: "mealPortion-1", label: "항상 정량을 지켜요", value: 8 },
      { key: "mealPortion-2", label: "가끔 조금 더 주게 돼요", value: 6 },
