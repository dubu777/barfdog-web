...
export const SKIN_SURVEY_ITEMS = [
  ...
  },
  {
    ...
    options: [
      { key: "bathing-1", label: "잘 조절하고 있어요", value: 8 },
      { key: "bathing-2", label: "기본 목욕 주기만 지켜요", value: 6 },
      { key: "bathing-3", label: "잘 모르겠어요", value: 3 },
  ...
  },
  {
    ...
    options: [
      { key: "postBathDry-1", label: "완전히 건조시켜요", value: 8 },
      { key: "postBathDry-2", label: "어느 정도만 말려요", value: 6 },
      { key: "postBathDry-3", label: "자연 건조해요", value: 3 },
  ...
  },
  {
    ...
    options: [
      { key: "postWalkClean-1", label: "항상 닦아요", value: 8 },
      { key: "postWalkClean-2", label: "종종 닦아요", value: 6 },
      { key: "postWalkClean-3", label: "거의 닦아주지 않아요", value: 3 },
  ...
  },
  {
    ...
    options: [
      { key: "indoorEnvironment-1", label: "주기적으로 관리해요", value: 8 },
      { key: "indoorEnvironment-2", label: "가끔 관리해요", value: 6 },
      { key: "indoorEnvironment-3", label: "거의 관리하지 않아요", value: 3 },
  ...
  },
  {
    ...
    options: [
      ...
      { key: "coatCare-2", label: "가끔 털을 빗겨주고 손질해요", value: 6 },
      { key: "coatCare-3", label: "외출할 때 어쩌다 한 번 손질해요", value: 3 },
