...
//     onToggle: onToggleChangeGram,
//   } = useModal();
//   const {
//     isOpen: isOpenChangePrice,
//     onClose: onCloseChangePrice,
//     onToggle: onToggleChangePrice,
//   } = useModal();
...
//     dirtyFields,
//     clearErrors,
//   } = useFormHandler<DogFormValues>(
//     dogInfoSchema(dogOriginalName),
//     defaultDogInfoValues(dogInfo)
//   );
...
//     dirtyFields?.oldDog ||
//     (dirtyFields?.weight &&
//       Number(watch("weight")) !== Number(dogOriginalWeight)) ||
//     false;
