...
interface CheckoutFailedModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function CheckoutFailedModal({
  isOpen,
  onClose,
}: CheckoutFailedModalProps) {
  const router = useRouter();
  return (
    <FullModalWrapper isVisible={isOpen} animationType="none">
      <div
