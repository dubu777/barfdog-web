...
export default function ProductionSection() {
  ...
  return (
    <>
          ...
          <Fragment key={point.label}>
            <li className={mainProductionPoint}>
              <Image
                ...
                priority
              />
              <Text type="headline4" color="white" preLine align="center">
                {point.label}
              </Text>
            </li>
      ...
      <MainContainer backgroundColor="gray200" paddingBottom={0} paddingY={0}>
        <MainTitle title={title} subTitle={subTitle} paddingTop={60} />
