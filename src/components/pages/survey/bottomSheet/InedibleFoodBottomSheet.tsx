...
export default function InedibleBottomSheet({
  ...
  return (
    ...
    >
      ...
      <DefaultText type="headline1">바프독의 모든 레시피에는 영양분이 가득한 육고기, 뼈, 내장, 채소 등이 들어가요</DefaultText>
      <DefaultText type="body2" color="gray600">육고기와 뼈의 경우 알러지 분류에 들어가지만 내장의 경우 알러지 분류에 들어가지 않으니 참고해 주세요</DefaultText>
      </div>
      <ButtonDocked
        type="full-button"
