...
import { signupTermsContent } from "../steps/SignupStep.css";

interface ServicePolicyProps {
  openList: () => void;
}

export default function ServicePolicy({ openList }: ServicePolicyProps) {
  return (
    <div className={commonWrapper({ direction: "col", gap: 20 })}>
      <Header centerTitle="이용약관 안내" showCloseButton onClose={openList} />
      <div className={signupTermsContent}>
        <Text type="caption">
          <h6>제1조(목적)</h6>
          이 약관은 주식회사 프레쉬아워(전자상거래 사업자)가 운영하는
          BARFDOG®(이하 &quot;몰&quot;이라 한다)에서 제공하는 인터넷 관련
          ...
          신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 BARFDOG®의
          초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가
          연결화면을 통하여 볼 수 있도록 할 수 있습니다.
          <br />
          ② &quot;몰은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용
          중 청약철회․배송책임․환불조건 등과 같은 중요한 내용을 이용자가 이해할
          수 있도록 별도의 연결화면 또는 팝업화면 등을 제공하여 이용자의 확인을
          구하여야 합니다.
          <br />
          ...
          공지합니다.이 경우 &quot;몰&quot;은 개정 전 내용과 개정 후 내용을
          ...
          체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한
          개정약관의 공지기간 내에 &quot;몰&quot;에 송신하여 &quot;몰&quot;의
          ...
          체결된 재화 또는 용역의 배송 3. 기타 &quot;몰&quot;이 정하는 업무
          <br />
          ...
          단, &quot;몰&quot;이 고의 또는 과실이 없음을 입증하는 경우에는
          그러하지 아니합니다.
          <br />
          ③ 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를
          제공할 수 없게 되는 경우에는 &quot;몰&quot;은 제8조에 정한 방법으로
          이용자에게 통지하고 당초 &quot;몰&quot;에서 제시한 조건에 따라
          소비자에게 보상합니다. 다만, &quot;몰&quot;이 보상기준 등을 고지하지
          아니한 경우에는 이용자들의 마일리지 또는 적립금 등을
          &quot;몰&quot;에서 통용되는 통화가치에 상응하는 현물 또는 현금으로
          이용자에게 지급합니다.
          <br />
          <br />
          <h6>제6조(회원가입)</h6>
          ...
          반하는 행위를 하는 경우
          <br />
          5. 만 19세 미만 미성년자가 이용계약을 하려면 반드시 이용계약에 관한
          법정대리인(부모)의 동의를 받아야하며, 법정대리인의 이용계약에 관한
          동의 의사표시는 몰에서 정한 필요 서류를 이메일로 몰의 고객센터에
          제출하는 것으로 확인합니다. 만약, 만 19세 미성년자인 회원이
          법정대리인의 동의 없이 허위로 계약하는 경우 본인 또는 법정대리인이
          이를 취소할 수 있습니다.
          <br />
          ...
          <br />
          <h6>제8조(회원에 대한 통지)</h6>
          ① &quot;몰&quot;이 회원에 대한 통지를 하는 경우, 회원이
          &quot;몰&quot;과 미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.
          <br />
          ...
          업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보
          ...
          거치지 않아도 됩니다.
          <br />
          ④  &quot;몰&quot;이 호스팅을 변경하여 이전 할 경우 1년 동안 로그인하지
          않은 휴면회원을 포함한 모든 &quot;이용자&quot;의 정보를 호스팅사에서
          제공받아 이전하는 호스팅사에 고객의 정보를 등록하고 &quot;몰&quot;의
          ...
          &quot;몰&quot;은 배송 전에 이용자의 요청이 있는 경우에는 지체 없이 그
          ...
          부담합니다. &quot;몰&quot;은 이용자에게 청약철회 등을 이유로 위약금
          ...
          &quot;몰&quot;은 청약철회 시 그 비용을누가 부담하는지를 이용자가 알기
          쉽도록 명확하게 표시합니다.
          <br />
          <br />
          <h6>제17조(개인정보보호)</h6>
          ...
          수집하지 않습니다. 다만, 관련 법령상 의무이행을 위하여 구매계약 이전에
          ...
          지체 없이 필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을
          요구한 경우에는 &quot;몰&quot;은 그 오류를 정정할 때까지 당해
          개인정보를 이용하지 않습니다.
          <br />
          ⑦ &quot;몰&quot;은 개인정보 보호를 위하여 이용자의 개인정보를 취급하는
          자를최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한 이용자의
          ...
          ① 상위 &quot;몰&quot;과 하위 &quot;몰&quot;이 하이퍼링크(예:
          하이퍼링크의 대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로
          연결된 경우, 전자를 연결 &quot;몰&quot;(웹 사이트)이라고 하고 후자를
          피연결 &quot;몰&quot;(웹사이트)이라고 합니다.
          <br />
          ② 연결&quot;몰&quot;은 피연결&quot;몰&quot;이 독자적으로 제공하는 재화
          등에 의하여 이용자와 행하는 거래에 대해서 보증 책임을 지지 않는다는
          뜻을 연결&quot;몰&quot;의 초기화면 또는 연결되는 시점의 팝업화면으로
          명시한 경우에는 그 거래에 대한 보증 책임을 지지 않습니다.
          <br />
          <br />
          ...
          &quot;몰&quot;에 귀속합니다.
          <br />
          ② 이용자는 &quot;몰&quot;을 이용함으로써 얻은 정보 중
          &quot;몰&quot;에게 지적재산권이 귀속된 정보를 &quot;몰&quot;의 사전
