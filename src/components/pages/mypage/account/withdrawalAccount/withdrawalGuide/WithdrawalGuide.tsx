	...
	const guideSteps: GuideSteps[] = [
		{
			...
			component: <MembershipCard tier={userMembershipTier as MembershipTier} className={styles.guideCard} />,
		},
		{
			id: 2,
			title: '포인트와 쿠폰이 모두 소멸됩니다',
			description: '탈퇴 시 누적 포인트와 쿠폰 내역이 모두 소멸됩니다\n재가입 시에도 해당 내역은 복구되지 않습니다',
			component: <UserRewardCard myPageData={myPageData} isDisabled className={styles.guideCard} />,
		},
		{
			id: 3,
			title: '건강 문진 기록, 식단 구독 내역 등\n반려견에 대한 소중한 기록이 사라져요',
