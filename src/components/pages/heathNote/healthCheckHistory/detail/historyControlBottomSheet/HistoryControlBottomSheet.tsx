...
const HistoryControlBottomSheet = ({
	isOpen,
	onClose,
	handleEdit,
	handleDelete,
	...
	return (
		...
		>
			<DefaultText type='title4' className={styles.controlBottomSheetTitle}>건강검진 내역</DefaultText>
			<div className={styles.controlBottomSheetActions}>
				...
				>
					<span className={pointColor}>건강검진 내역 삭제</span>
				</Button>
			</div>
		</BottomSheet>
	);
...
export default HistoryControlBottomSheet;