...
import { RESULT_DOG_SIZE_ICON_MAP, RESULT_HEALTH_STATUS_ICON_MAP } from "@/constants";
...
const TotalScore = ({
	...
	return (
		<ResultCard
			...
			title={`${dogName}의\n건강 종합 점수`}
		>
			<CircleProgressBar score={totalScore} svgImage={RESULT_HEALTH_STATUS_ICON_MAP[healthStatusKey]} />
			...
			<DefaultText type='caption2' color='gray600' align='center'>※ 해당 결과지는 바프독 고객을 대상으로한 참고용 결과이니,자세한 반려견 건강 상태는 담당 수의사와 상담해 주세요.</DefaultText>
		</ResultCard>
	);
};
