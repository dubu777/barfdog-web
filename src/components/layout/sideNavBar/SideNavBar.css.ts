...
export const navWrapper = style({
  borderTop: `1px solid ${themeVars.colors.gray.gray800}`,
  borderBottom: `1px solid ${themeVars.colors.gray.gray800}`,
});
...
export const navItems = style({
  ...
  textAlign: "left",
  borderTop: `0.35px solid ${themeVars.colors.gray.gray200}`,
  borderBottom: `0.35px solid ${themeVars.colors.gray.gray200}`,
